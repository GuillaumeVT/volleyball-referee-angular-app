...
export class ColorPickerDialogComponent {
  ...
  constructor(public dialogRef: MatDialogRef<ColorPickerDialogComponent>, @Inject(MAT_DIALOG_DATA) public data: string, public playerStyleService: PlayerStyleService) {
